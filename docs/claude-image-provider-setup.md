...
Codex production runs must use native Codex ImageGen and must not use API image generation.
...
Use the safest available local environment or connector configuration.
